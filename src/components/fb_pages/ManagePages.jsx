...
import { loadGroupPages, loadGroup, attachPageToGroup } from '../../action/groupActions';
import { pageSearch } from '../../action/pageActions';
                    ...
                    <Col className="gutter-row" md={8}>
                        <div className="gutter-box">
                            <Card title="Track a new Page" bordered={false}>
                                <PageSearch pages={this.props.pages} actions={this.props.actions} onSelect={this.onPageSearchSelect} />
                            </Card>
                        </div>
                    </Col>
...
function mapDispatchToProps(dispatch) {
    return {
        actions: bindActionCreators({loadGroupPages, loadGroup, pageSearch, attachPageToGroup}, dispatch)
    }
}
